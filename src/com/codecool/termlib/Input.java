...
public class Input {
    private static HashSet<Character> validFirstCoordinateInputs = new HashSet<>(){{add('a'); add('b'); add('c'); add('d');}};
    private static HashSet<Character> validSecondCoordinateInputs = new HashSet<>(){{add('1'); add('2'); add('3'); add('4');}};
    private static HashMap<Character, Integer> gridCoordinates = new HashMap<>(){{put('a', 1); put('b', 2); put('c', 3); put('d', 4);}};
